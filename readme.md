Using Giphy's API format to make a fun website
    ...
    Week 6 assignment in coding bootcamp.

Titled : Super Hero Gifs

    Created with intentions to learn more about how to use API and JSON calls.  This was also my first attempt at using local storage to store favorites. 
...
Motivation
    ...
    I wanted to work with bootstrap, and use CSS to clean things up to make it all flow neatly.
